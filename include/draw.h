...
public:
	...
	metapost_control(): frame_minx(0), frame_maxx(0), frame_miny(0),frame_maxy(0),rotate(false), explicit_rotation_centre(false), implicit_rotation_centre(false),
	                    ...
	                    unit_size(20), disc_size(30), smoothed_state_disc_size(6), pen_size(1), horizontal_units(5), vertical_units(5),
						infinite_cycle(-1), arrowhead_bp_size(6),cudgel_space(1.0), dash_with_dots(false), knotoid_leg_unbounded(false), one_metapost_path(false),
						colour(false), draw_lace_frame(false), draw_immersion(true), draw_crossing_features(true), draw_frame_corners(false), draw_immersion_bounds(false),
						...
						draw_shortcut(false), label_vertices(false), script_labels(false), scriptscript_labels(false), show_odd_parity_crossings(false), 
						...
						left_terminating_tail_points(false), midpoints_not_tail_points(false),midpoint_tension(1.0),colourmap(""),singlecolour(""),
